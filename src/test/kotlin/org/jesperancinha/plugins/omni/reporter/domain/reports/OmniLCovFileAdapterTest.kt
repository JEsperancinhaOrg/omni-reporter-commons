...
internal class OmniLCovFileAdapterTest {
    ...
    @Test
    fun `should correct paths relative to root for LCov in Codecov report sending`() {
        ...
        val generatePayload = omniLCovFileAdapter.generatePayload(false, listOf(File(root, "app1/app2")))
